...
const MedicalHistory = () => {
  // Mock Data
  const conditions = [
    { id: 1, name: 'Hypertension', diagnosed: '2020-05-12', status: 'Active', doctor: 'Dr. Sarah Ahmed' },
    { id: 2, name: 'Type 2 Diabetes', diagnosed: '2021-02-15', status: 'Active', doctor: 'Dr. Rahim Khan' },
    { id: 3, name: 'Seasonal Allergies', diagnosed: '2018-03-10', status: 'Active', doctor: 'Dr. Emily Chen' },
  ];

  const allergies = [
    { id: 1, allergen: 'Penicillin', reaction: 'Hives, Swelling', severity: 'Severe' },
    { id: 2, allergen: 'Peanuts', reaction: 'Anaphylaxis', severity: 'Critical' },
  ];

  const surgeries = [
    { id: 1, procedure: 'Appendectomy', date: '2015-08-22', surgeon: 'Dr. Johnson', hospital: 'General Hospital' },
    { id: 2, procedure: 'Knee Arthroscopy', date: '2019-11-05', surgeon: 'Dr. Lee', hospital: 'Ortho Care Center' },
  ];

  const immunizations = [
    { id: 1, vaccine: 'Influenza', date: '2023-10-01', provider: 'CityCare Clinic' },
    { id: 2, vaccine: 'COVID-19 Booster', date: '2023-01-15', provider: 'CityCare Clinic' },
    { id: 3, vaccine: 'Tetanus', date: '2020-06-20', provider: 'General Hospital' },
  ];
